    ...
    <div className="container mx-auto p-6 max-w-md">
      <Card className="shadow-lg">
        ...
        <Row gutter={16} justify="center">
          <Col span={12}>
            <Card className="text-center bg-green-50 border-green-200" hoverable>
              {/* <DollarSign className="w-8 h-8 mx-auto text-green-600 mb-2" /> */}
              <h3 className="text-lg font-semibold text-gray-800">Capital</h3>
          ...
          <Col span={12}>
            <Card className="text-center bg-blue-50 border-blue-200" hoverable>
